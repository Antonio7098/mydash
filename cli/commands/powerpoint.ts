...
import { prepareOutputDirectory } from "../../src/files/directory-output.js";
...
export const powerpointCommand: CommandDefinition = {
  name: "powerpoint",
...
function resolveWorkspaceOutput(
  input: string,
  workspaceRoot: string | undefined,
): string {
  if (!workspaceRoot) {
...
function renderInspection(data: PresentationInspection): string {
  return [
