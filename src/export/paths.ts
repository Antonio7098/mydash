...
export async function resolveExportSourcePath(
  ...
  options: ResolveExportSourceOptions = {},
...
export function isInlineSafeReference(value: string): boolean {
  return (
...
export function splitReference(value: string): { path: string; suffix: string } {
...
function exportPathError(code: string, message: string): Error {
