export type ManifestSpecContract =
  | "artifact"
  | "uiItem"
  | "theme"
  | "preset"
...
export function manifestSpecForRoot(rootKey: string): ManifestSpec | null {
  return MANIFEST_SPECS.find((spec) => spec.rootKey === rootKey) ?? null;
}

export interface PlacementExpectation {
  expectedLevel: "core" | "collection" | null;
