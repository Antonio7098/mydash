...
function createArtifactCard(
  ...
  if (!options.previewOnly) {
    loading.append(
      element(
        "span",
        "artifact-preview-status__label",
        "Preview waiting",
      ),
    );
  }
  ...
  if (options.previewOnly) {
    const glass = element(
      "div",
      "artifact-gallery-item__glass",
    );
    const name = element(
      "a",
      "artifact-gallery-item__name",
      artifact.title,
    );
    name.href =
      artifactViewerPath(
    ...
    name.dataset.navigatorLink =
      "";
    glass.append(mount);
    const copy = element(
      "div",
      "artifact-gallery-item__copy",
    );
    copy.append(name);
    if (artifact.description) {
      copy.append(
        element(
          "p",
          "artifact-gallery-item__subtitle",
          artifact.description,
        ),
      );
    }
    card.append(glass, copy);
    return card;
  }
