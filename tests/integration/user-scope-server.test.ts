...
async function addOtherUserArtifact(root: string) {
...
function resourceIds(body: { data: { entries: Array<{ category?: string; kind: string; id: string }> } }) {
